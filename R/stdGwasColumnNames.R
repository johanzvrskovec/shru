...
stdGwasColumnNames <- function(
  ...
  c.AEFFECT = unique(c("EA","AF","INC_ALLELE","A1_EFFECT","EFFECT_ALLELE","RISK_ALLELE","EFFECTALLELE","EFFECT_ALL","INC_ALLELE","CODED_ALLELE","TESTED_ALLELE","EFFECT.ALLELE..EA."))
  ...
  c.AREFERENCE = unique(c("REF","REFERENCE_ALLELE","REF_ALLELE","REFERENCEALLELE", "REFALLELE"))
  c.ANOREFERENCE = unique(c("NOREF","NONREF","NONREFERENCE_ALLELE","NONREF_ALLELE","NONREFERENCEALLELE", "NONREFALLELE"))
  c.BETA = c("BETA","B","EFFECT_BETA","EFFECT","EFFECTS","SIGNED_SUMSTAT","EST","GWAS_BETA","EFFECT_A1","EFFECTA1","EFFECT_NW","STDBETA","ES")
  ...
  c.INFO = c("INFO","IMPINFO","IMPQUALITY", "INFO.PLINK", "INFO_UKBB","INFO_UKB","MININFO","SI")
  c.SINFO = c("SINFO")
  ...
  c.P.adj = paste0(c.P,"_ADJ")
  c.P.unadj = paste0(c.P,"_UNADJ")
  c.LP = c("LP","NL10P","NEGLOG10_PVAL") # -log10 p-value, used in the Pan UKB format, and in the GWAS VCF format
  c.N = c("N","NCOMPLETESAMPLES","TOTALSAMPLESIZE","TOTALN","TOTAL_N","N_COMPLETE_SAMPLES","N_TOTAL","N_SAMPLES","N_ANALYZED","NSAMPLES","SAMPLESIZE","SAMPLE_SIZE","TOTAL_SAMPLE_SIZE","TOTALSAMPLESIZE","SAMPLE.SIZE","N_SUM","SIZE","NS","SS")
  c.N_CAS = c("N_CAS","NCASE","N_CASE","N_CASES","NCAS","NCA","NCASES","CASES","CASES_N","FRQ_A","NC")
  ...
  c.NEFF_HALF = c("NEFF_HALF","NEFFDIV2","EFFECTIVE_CASES")
  #include FRQ_A?
  c.FRQ = unique(c("FRQ","MAF","AF","AF1","CEUAF","FREQ","FREQ1","EAF","FREQ1.HAPMAP","FREQALLELE1HAPMAPCEU","FREQ.HAPMAP.CEU","FREQ.ALLELE1.HAPMAPCEU","EFFECT_ALLELE_FREQ","FREQ.A1","F_A","F_U","FREQ_A","FREQ_U","MA_FREQ","MAF_NW","FREQ_A1","A1FREQ","CODED_ALLELE_FREQUENCY","FREQ_TESTED_ALLELE","FREQ_TESTED_ALLELE_IN_HRS","EAF_HRC","EAF_UKB","EAF_EUR_UKB","EFFECT_ALLELE_FREQUENCY","EFFECT.ALLELE.FREQUENCY..EAF.","EFFECTALLELEMAF"))
  c.FRQ_CAS = c("FRQ_CAS","FCAS")
  c.FRQ_CON = c("FRQ_CON","FCON")
  c.CHR = unique(c("CHR","CH","CHROMOSOME","CHROM","CHR_BUILD38","CHR_BUILD37","CHR_BUILD36","CHR_B38","CHR_B37","CHR_B36","CHR_ID","SCAFFOLD","HG19CHR","CHR.HG19","CHR_HG19","HG18CHR","CHR.HG18","CHR_HG18","CHR_BP_HG19B37","HG19CHRC","#CHROM","X.CHROM","CHROSOME"))
  c.BP = unique(c("BP","BP1","ORIGBP","POS","POSITION","LOCATION","PHYSPOS","GENPOS","CHR_POSITION","POS_B38","POS_BUILD38","POS_B37","POS_BUILD37","BP_HG19B37","POS_B36","POS_BUILD36","POS.HG19","POS.HG18","POS_HG19","POS_HG18","BP_HG19","BP_HG18","BP.GRCH38","BP.GRCH37","POSITION(HG19)","POSITION(HG18)","POS(B38)","POS(B37)","BASE_PAIR_LOCATION"))
  c.BP2 =c("BP2")
  c.L2 =c("L2","LD")
  c.DF = c("DF","CHISQ_DF")
  ...
  columnNames[columnNames.upper %in% c.LP] <- c.LP[1]
